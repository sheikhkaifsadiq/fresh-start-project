...
// Standard Web API Request — compatible with Cloudflare Workers, TanStack Start, and Node.
// Previously imported NextRequest from 'next/server' which would fail on Cloudflare.
